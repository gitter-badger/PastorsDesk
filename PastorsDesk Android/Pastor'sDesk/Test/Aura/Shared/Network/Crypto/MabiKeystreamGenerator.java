...
public final class MabiKeystreamGenerator   
{
    ...
    *  @return The key
    */
    public uint getNextKey() throws Exception {
        _keySetIndex--;
        if (_keySetIndex < 256)
        {
            _state3++;
            UInt32 var1 = _state1;
            UInt32 var2 = _state2 + _state3;
            for (Int32 i = 0;i < 256;)
            {
                uint j, k;
