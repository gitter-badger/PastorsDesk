...
namespace PastorsDesk.Shared.Network
{
    ...
    public class Packet
    {
        ...
        public Packet PutLong(DateTime val) { return PutLong(val.Ticks / 10000); }
        ...
        /// <summary>Writes val as null-terminated UTF8 string to buffer.</summary>
        public Packet PutString(string format, params object[] args) { return PutString(string.Format((format ?? string.Empty), args)); }
